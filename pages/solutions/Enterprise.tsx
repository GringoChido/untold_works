    ...
    <div className="bg-untold-beige font-serif text-untold-black">
      ...
      <section className="bg-untold-beige/60 border-b border-untold-border px-5 sm:px-10 py-8 sm:py-10">
        <div className="max-w-[1440px] mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-untold-black/40 max-w-md">{t({ en: 'Every enterprise system includes SEO, AEO & GEO — establishing your AI identity across departments and locations from day one.', es: 'Cada sistema empresarial incluye SEO, AEO y GEO — estableciendo tu identidad de IA en todos los departamentos y ubicaciones desde el día uno.' })}</p>
        </div>
      </section>
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="max-w-3xl">
            ...
            <div className="pt-6 border-t border-untold-border">
              ...
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-untold-gray mt-1">Founder, Second Son Productions</p>
            </div>
          </div>
        </div>
      </section>
