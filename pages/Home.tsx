    ...
    <div className="bg-untold-beige font-serif text-untold-black">
      ...
      <section className="bg-untold-black text-white px-5 sm:px-10 py-20 sm:py-32 lg:py-56 border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto relative">
          ...
          <h1 className="font-sans font-black text-[clamp(2.8rem,12vw,180px)] leading-[0.82] mb-8 tracking-tighter uppercase max-w-[1400px]">
            {t(i18n.hero.headline)}
          </h1>
          
          <h2 className="text-xl sm:text-2xl lg:text-[42px] font-serif italic text-untold-orange leading-[1.15] tracking-tight mb-10 sm:mb-16 max-w-5xl">
          ...
          <div className="border-t border-untold-border">
            {[i18n.model.design, i18n.model.build, i18n.model.operate].map((step, idx) => (
              <div key={idx} className="grid lg:grid-cols-12 gap-0 border-b border-untold-border group hover:bg-untold-beige transition-all duration-700">
                <div className="lg:col-span-5 p-6 sm:p-12 lg:p-20 border-r border-untold-border">
                ...
                <div className="lg:col-span-7 p-6 sm:p-12 lg:p-20 flex flex-col justify-between">
      ...
      <section className="px-5 sm:px-10 py-20 sm:py-32 bg-untold-black text-white border-b border-white/5">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex items-center space-x-4 mb-20">
            <span className="w-2.5 h-2.5 rounded-full bg-untold-orange"></span>
            <h2 className="font-mono text-[13px] uppercase tracking-[0.6em] font-bold text-white/40">{t(i18n.servicePillars.title)}</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-px bg-white/10">
            ...
            <div className="bg-untold-black p-6 sm:p-12 lg:p-16 group hover:bg-white/5 transition-all">
              ...
              <p className="text-lg lg:text-xl font-serif text-white/70 leading-relaxed mb-10">
      ...
      <section className="bg-untold-black text-white py-20 sm:py-32 overflow-hidden border-b border-white/5">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-10">
           ...
           <div className="grid lg:grid-cols-2 gap-px bg-white/10 border border-white/10 mb-24">
              {i18n.proofs.slice(0, 2).map((artifact, idx) => {
                ...
                return (
                  <Link to={`/portfolio/${projectId}`} key={idx} className="bg-untold-black p-6 sm:p-12 lg:p-20 flex flex-col justify-between group min-h-[500px] sm:min-h-[700px] hover:bg-white/5 transition-all">
                    <div className="mb-20">
                    ...
                    <div className="flex flex-wrap gap-4 pt-12">
                      {artifact.tags.map(tag => (
                        <div key={tag} className="border border-white/10 px-6 py-2 font-mono text-[10px] uppercase tracking-[0.3em] text-white/30 group-hover:text-white group-hover:border-white/50 transition-all">
                          {tag}
                        </div>
                      ))}
                    </div>
