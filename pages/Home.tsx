    ...
    <div className="bg-untold-beige font-serif text-untold-black">
      ...
      <section className="bg-untold-black text-white px-10 py-32 lg:py-56 border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto relative">
          ...
          <h2 className="text-2xl lg:text-[42px] font-serif italic text-untold-orange leading-[1.1] tracking-tight mb-16 max-w-5xl">
            {t(i18n.hero.subheadline)}
          </h2>

          <div className="grid lg:grid-cols-12 gap-16 lg:gap-32 items-end">
            <div className="lg:col-span-8 space-y-16">
              <p className="text-xl lg:text-3xl font-serif text-white/80 leading-[1.25] tracking-tight max-w-4xl border-l-4 border-untold-orange pl-10">
      ...
      <section className="px-10 py-32 bg-untold-black text-white border-b border-white/5">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-px bg-white/10">
            {/* Content Systems */}
            <div className="bg-untold-black p-12 lg:p-16 group hover:bg-white/5 transition-all">
              <div className="mb-10">
