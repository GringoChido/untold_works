    ...
    <div className="relative">
      ...
      >
        ...
        <div className="p-3 sm:p-5 space-y-4">
          ...
          {/* Cassette deck bay */}
          <div className="relative bg-[#0d0d0d] rounded-sm p-3 sm:p-4 border border-white/5"
            style={{ boxShadow: 'inset 0 2px 6px rgba(0,0,0,0.5)' }}
          >
            <CassetteDeck playing={state.playing} power={state.power} progress={state.progress} />
          </div>
