...
// Fragment shader — adapted to brand orange (#FF4D17) palette
const fsSource = `
  ...
  // Brand orange line color: #FF4D17 → rgb(1.0, 0.3, 0.09)
  const vec4 lineColor = vec4(1.0, 0.3, 0.09, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    // Dark warm background: near-black with subtle orange undertone
    vec4 bgColor1 = vec4(0.02, 0.01, 0.0, 1.0);
    vec4 bgColor2 = vec4(0.08, 0.02, 0.0, 1.0);
