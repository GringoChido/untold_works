...
export const projects: Project[] = [
  ...
  },
  {
    ...
    challenge: {
      en: 'Noxguard had 15+ years manufacturing and distributing the highest quality automotive urea (DEF) across Mexico as a subsidiary of Transliquid Technologies in Houston, but the business had outgrown its infrastructure. Brand identity was disconnected from market positioning. Sales teams had no digital tools — reps were quoting manually with no fleet-specific data. Distribution routes were planned on spreadsheets with no demand forecasting. Fleet customers had no self-service ordering, no visibility into tank levels, and no way to generate the ESG compliance reports that enterprise logistics firms increasingly require. The entire operation — from how the brand communicated its value to how product moved through the supply chain — needed to be rebuilt for scale.',
      es: 'Noxguard tenía más de 15 años fabricando y distribuyendo urea automotriz (DEF) de la más alta calidad en México como subsidiaria de Transliquid Technologies en Houston, pero el negocio había superado su infraestructura. La identidad de marca estaba desconectada del posicionamiento de mercado. Los equipos de ventas no tenían herramientas digitales — los representantes cotizaban manualmente sin datos específicos de flotas. Las rutas de distribución se planeaban en hojas de cálculo sin pronóstico de demanda. Los clientes de flotas no tenían pedidos de autoservicio, sin visibilidad de niveles de tanque, y sin forma de generar los reportes de cumplimiento ESG que las empresas de logística cada vez más requieren. Toda la operación — desde cómo la marca comunicaba su valor hasta cómo el producto se movía por la cadena de suministro — necesitaba ser reconstruida para escalar.'
    },
    goal: {
      en: 'Transform Noxguard at every layer: redefine the brand and business strategy to own the clean transport narrative in North America, arm the sales team with AI-powered tools that close fleet contracts faster, and build intelligent infrastructure that optimizes internal logistics while giving customers self-service AI products they can\'t get from any other DEF supplier in Mexico.',
      es: 'Transformar Noxguard en cada capa: redefinir la marca y estrategia de negocio para dominar la narrativa de transporte limpio en Norteamérica, armar al equipo de ventas con herramientas potenciadas por IA que cierren contratos de flotas más rápido, y construir infraestructura inteligente que optimice la logística interna mientras ofrece a los clientes productos de IA de autoservicio que no pueden obtener de ningún otro proveedor de DEF en México.'
    },
    solution: {
      en: 'Phase 1 — Brand & Business Strategy: Rebuilt the brand identity from the ground up. Defined a new mission ("Accelerating Mexican Logistics Toward Net-Zero"), vision, and three core values: Chemical Integrity (Houston-grade manufacturing standards), Regional Agility (deep expertise in Mexican infrastructure), and Data Transparency (AI-driven proof of emissions reduction). Designed a mobile-first visual system with high-contrast UI for drivers in direct sunlight. Then reorganized the entire business around three strategic revenue pillars: Compliance First (positioning DEF as the only path to meet NOM-044 environmental regulations), Total Cost of Ownership (preventing SCR system failure and expensive fleet downtime), and Cross-Border Synergy (leveraging the Texas-Mexico supply chain as a reliability advantage). Phase 2 — Sales Enablement: Built a Fleet Carbon Audit Tool — a mobile app where reps input fleet size and mileage to calculate specific NOx reduction targets and generate custom proposals on-site. Created an AI-indexed Technical Knowledge Base — a searchable repository of SCR maintenance guides for fleet mechanics. Engineered an Automated Case Study Generator that pulls real delivery data to produce localized PDFs showing fuel savings and compliance results per customer. Phase 3 — Internal AI Operations: Deployed Route and Load Optimization AI to minimize the carbon footprint of Noxguard\'s own distribution fleet across Mexico. Built a Predictive Inventory Engine that analyzes Mexican harvest seasons, shipping peaks, and regional consumption patterns to preposition urea stock before demand spikes. Created a Regulatory Monitoring Bot that continuously tracks changes in Mexican environmental law (NOM standards) and Texas export regulations, alerting leadership to compliance risks before they materialize. Phase 4 — Customer-Facing AI Products: Launched WhatsApp Smart Dispatch — a chatbot that lets Mexican fleet drivers order DEF refills or report contaminated tanks using voice notes, built for the way drivers actually communicate in the field. Built a Consumption Forecasting API — a dashboard for large logistics firms to see exactly when their bulk tanks will hit 10% capacity, enabling automatic reorder triggers. Deployed an Emissions Reporting Portal — a one-click generator for customers to include Noxguard urea usage data in their annual ESG reports, turning a commodity product into a compliance asset.',
      es: 'Fase 1 — Marca y Estrategia de Negocio: Reconstruimos la identidad de marca desde cero. Definimos una nueva misión ("Acelerando la Logística Mexicana Hacia Cero Emisiones"), visión y tres valores fundamentales: Integridad Química (estándares de manufactura grado Houston), Agilidad Regional (experiencia profunda en infraestructura mexicana) y Transparencia de Datos (prueba de reducción de emisiones impulsada por IA). Diseñamos un sistema visual mobile-first con UI de alto contraste para conductores bajo luz solar directa. Luego reorganizamos todo el negocio en tres pilares estratégicos de ingresos: Cumplimiento Primero (posicionar DEF como el único camino para cumplir regulaciones ambientales NOM-044), Costo Total de Propiedad (prevenir fallas del sistema SCR y costoso tiempo de inactividad de flotas) y Sinergia Transfronteriza (aprovechar la cadena de suministro Texas-México como ventaja de confiabilidad). Fase 2 — Habilitación de Ventas: Construimos una Herramienta de Auditoría de Carbono de Flotas — una app móvil donde los representantes ingresan el tamaño de flota y kilometraje para calcular objetivos específicos de reducción de NOx y generar propuestas personalizadas en sitio. Creamos una Base de Conocimiento Técnico indexada por IA — un repositorio buscable de guías de mantenimiento SCR para mecánicos de flotas. Diseñamos un Generador Automatizado de Casos de Estudio que extrae datos reales de entregas para producir PDFs localizados mostrando ahorros de combustible y resultados de cumplimiento por cliente. Fase 3 — Operaciones de IA Interna: Desplegamos IA de Optimización de Rutas y Carga para minimizar la huella de carbono de la propia flota de distribución de Noxguard en México. Construimos un Motor de Inventario Predictivo que analiza temporadas de cosecha mexicanas, picos de envío y patrones de consumo regional para preposicionar stock de urea antes de los picos de demanda. Creamos un Bot de Monitoreo Regulatorio que rastrea continuamente cambios en la ley ambiental mexicana (normas NOM) y regulaciones de exportación de Texas, alertando al liderazgo sobre riesgos de cumplimiento antes de que se materialicen. Fase 4 — Productos de IA Orientados al Cliente: Lanzamos WhatsApp Smart Dispatch — un chatbot que permite a los conductores de flotas mexicanos pedir recargas de DEF o reportar tanques contaminados usando notas de voz, construido para la forma en que los conductores realmente se comunican en campo. Construimos una API de Pronóstico de Consumo — un dashboard para grandes empresas de logística para ver exactamente cuándo sus tanques a granel alcanzarán el 10% de capacidad, habilitando disparadores de reorden automático. Desplegamos un Portal de Reportes de Emisiones — un generador de un clic para que los clientes incluyan datos de uso de urea Noxguard en sus reportes anuales ESG, convirtiendo un producto commodity en un activo de cumplimiento.'
    },
    metrics: [
